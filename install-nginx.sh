...
cd /tmp
wget https://raw.githubusercontent.com/jacyl4/de_GWD/main/resource/nginx/nginx_amd64
mv -f /tmp/nginx_amd64 /usr/sbin/nginx && chmod +x /usr/sbin/nginx

wget https://raw.githubusercontent.com/jacyl4/de_GWD/main/resource/nginx/nginxConf.zip
